...
internal interface IMsQuicWebTransportHttpConnectionManager
{
    /// <summary>
    /// Creates an outbound unidirectional or bidirectional <see cref="QuicStream"/> using
    /// the <see cref="QuicConnection"/> associated with the HTTP/3 connection that is associated with this <see cref="IMsQuicWebTransportHttpConnectionManager"/>.
    /// </summary>
    ...
    Task RemoveSessionAsync(QuicStream connectStream);
}
