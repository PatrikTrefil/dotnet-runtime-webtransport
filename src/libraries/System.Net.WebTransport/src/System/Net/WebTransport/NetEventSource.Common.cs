...
// NOTE: This file is a copy of src/libraries/Common/src/System/Net/Logging/NetEventSource.Common.cs
// with the namespace changed from System.Net to System.Net.WebTransport.
//
// We cannot compile the shared Common file directly because System.Net.WebTransport uses
// SkipUseReferenceAssembly="true" on its System.Net.Http reference (to access internal types via
// InternalsVisibleTo). This exposes System.Net.Http's internal System.Net.NetEventSource, which
// would conflict (CS0436) with a locally-compiled copy in the same namespace.
//
// By placing the copy in System.Net.WebTransport namespace, there is no collision.
// When the Http3ExtendedConnect* types are promoted to public API (eliminating the need for IVT),
// this copy can be removed and the shared Common file can be used directly instead.
